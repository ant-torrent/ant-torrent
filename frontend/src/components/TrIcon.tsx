/**
 * Transmission 菜单图标（线稿版，源文件 SVG Repo）：
 * 原始 fill/stroke 写死黑色，改为 currentColor——跟随菜单文字颜色，
 * 深/浅色主题与选中主题色自动适配（与 @ant-design/icons 风格一致）。
 * className 必须透传——antd Menu 会注入 ant-menu-item-icon，其相邻选择器规则
 * 给菜单标题 10px 间距，丢弃则图标贴字。
 */
export function TrIcon({ style, className }: { style?: React.CSSProperties; className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 14 14"
